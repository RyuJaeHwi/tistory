...
![](https://blog.kakaocdn.net/dn/JlR9V/btsKl54poXY/sqyKakqN9Fbu0G09n1Sjo0/img.png)

글을 보면 Python은 input() 대신 sys.stdin.readline을 사용하여 빠른 출력을 하라고 권고하고 있다. 여기서 sys를 사용하려면 처음 코드파일에 import sys를 해주어야 한다.
